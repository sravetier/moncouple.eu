    ...
    <div className="pt-16">
      <div className="bg-[#85C196] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold text-center mb-4">Bibliothèque de guides pratiques</h1>
          <p className="text-xl text-center max-w-2xl mx-auto">
            Des ressources complètes pour vous accompagner à chaque étape de votre parcours
          </p>
        </div>
      </div>
